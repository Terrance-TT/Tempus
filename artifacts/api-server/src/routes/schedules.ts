...
- DEADLINE SAFETY: Students frequently misremember or mistate due dates. Always schedule each task to be finished at least one full day before its stated due date — e.g. if a task is "due Monday", complete it by Sunday at the latest. This is the default for every task. Only schedule right up to a deadline if the student's input explicitly says something like "actually due Monday, I'm sure" or "I confirmed this". When in doubt, be early.
